...
// Icons
import { FaBlenderPhone, FaInstagram, FaWhatsapp, FaSearch } from "react-icons/fa";
import { IoCartOutline } from "react-icons/io5";
import { MdEmail, MdLocationOn } from "react-icons/md";
        ...
        <div className="navbar-container d-flex align-items-center w-100">
          ...
          <div className="d-flex align-items-center gap-2 ms-auto">
            <div className="search-wrapper desktop d-none d-md-block">
              <input type="text" className="form-control search-input" placeholder="Search cakes..." />
              <button className="search-btn"><FaSearch /></button>
            </div>

            <div className="position-relative cursor-pointer" onClick={() => navigate("/cart")}>
              <IoCartOutline className="carticon" />
              {cartItems.length > 0 && <Badge bg="danger" className="cart-badge">{cartItems.length}</Badge>}
            </div>
